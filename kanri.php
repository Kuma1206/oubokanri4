...
try {
    $status = $stmt->execute();
    $result = $stmt->fetchAll(PDO::FETCH_ASSOC); // ここで全てのデータを取得
    if ($result) {
        $namae = $result[0]['namae']; // 最初のユーザーの名前を取得
    } else {
                ...
                <table>
                    ...
                    <?php foreach ($result as $record) : ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['nyugaku'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($record['n_gakkoumei'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($record['sotsugyou'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($record['s_gakkoumei'], ENT_QUOTES, 'UTF-8'); ?></td>
