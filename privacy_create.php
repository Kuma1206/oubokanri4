...
// SQLを準備する
$sql = 'INSERT INTO privacy (user_id, namae, furigana, gender, umare, nenrei, zipcode, zyusho, phone, email, shikaku, fuyou, kazoku, haifu, kibou, created_at, updated_at) VALUES (:user_id, :namae, :furigana, :gender, :umare, :nenrei, :zipcode, :zyusho, :phone, :email, :shikaku, :fuyou, :kazoku, :haifu, :kibou, now(), now())';
